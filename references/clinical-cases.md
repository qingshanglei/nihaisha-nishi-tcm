...
### **高优先级**  
1. 掌握“真寒假热”辨证方法，观察手脚温度与舌苔判断里寒证（课程04、22）。  
2. 学习四逆汤、分消汤的配伍逻辑，复刻课程中生附子与干姜的冷服技巧（课程04、09）。  
3. 练习头部（天柱穴）、足部（承山穴）针灸定位，熟悉贴骨下针操作（课程01、02）。  
4. 通过病例记录（如黑板板书）推演中药剂量调整，如酸枣仁汤加减（课程30）。  

### **中优先级**  
5. 分析“乌药+泽泻”组合对肾脏代谢的协同作用，结合患者小便变化验证疗效（课程36）。  
6. 掌握“三阴交”与“血海穴”进针技巧，避免快速刺入导致出血（课程02）。  
7. 学习《参同契》坎离卦象的中医应用，理解心肾相济的药方设计（课程06）。  
8. 制作常见方剂（小柴胡汤、桂枝汤）的加减对照表，标注寒热虚实配伍原则（课程05、12）。  

### **低优先级**  
9. 研究“桑螵蛸”在肾虚小便失禁中的作用机制，对比四物汤的瘀血风险（课程40）。  
10. 模拟“胃苓汤”改为粉剂的临床场景，思考剂型调整对药效的影响（课程14）。  
11. 记录不同穴位（如灵台穴、临苔穴）对应的经络与脏腑，建立取穴图谱（课程01）。  
12. 分析金铃子、延胡索在肝硬化镇痛中的配伍比例（课程08）。  
13. 练习“以药性归经理论选药”，如辛香入肺、色深入心（课程17）。  
14. 通过“时辰辨证”记录患者凌晨症状（如1-3点失眠），判断肝经郁滞（课程23）。  
15. 制作中药炮制差异表（生附子 vs. 炮附子），明确毒性与疗效的临床平衡（课程04、34）。  
