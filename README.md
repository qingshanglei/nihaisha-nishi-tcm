...
- **截图证据**：已接入 2888 张关键板书/PPT/实操截图索引，可按方名、穴位、课次、病机、术数关键词或时间点检索。
...
| 八纲辨证 | [`references/bagang.md`](./references/bagang.md) | 待补跑 |
| 扶阳论坛 | [`references/fuyang.md`](./references/fuyang.md) | 待补跑 |
| 易筋经 | [`references/yijinjing.md`](./references/yijinjing.md) | 待补跑 |
...
- 已整理并接入截图证据：`01.针灸课程`、`03.黄帝内经课程`、`05.神农本草课程`、`07.伤寒论课程`、`09.金匮要略课程`、`11.仲景心法传讲`、`13.人纪之临床案例`、`22.倪海厦天纪`。
- 已整理文本，截图证据待补跑：`14.人纪之八纲辨证`、`15.扶阳论坛`、`18.倪师易筋经`、`19.梁冬对话倪师`、`20.倪师斯坦福大学演讲`。
