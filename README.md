...
- **多课程检索**：覆盖伤寒论、金匮要略、仲景心法、临床案例、八纲辨证、扶阳论坛、易筋经、梁冬对话、斯坦福演讲、天纪、黄帝内经、神农本草和针灸课程。
- **六经与方证导航**：按六经、症状、方剂和传变逻辑整理《伤寒论》核心内容。
- **穴位与药性学习**：可检索针灸经络穴位、配穴思路，以及神农本草课程里的药性、剂型、配伍与单味药线索。
- **逐课复习**：按课程模块和课次整理主题地图、关键词和适合复习的问题。
- **截图证据**：已接入 2986 条截图证据索引，其中 2953 张关键板书/PPT/实操截图已压缩为仓库内 WebP 图片，可按方名、穴位、课次、病机、术数关键词或时间点检索。
...
| 八纲辨证 | [`references/bagang.md`](./references/bagang.md) | [`references/bagang-screenshot-evidence.md`](./references/bagang-screenshot-evidence.md) 33 条代表画面索引，未上传图片 |
...
> 截图索引优先返回仓库内 `assets/screenshots/...` 相对路径。八纲辨证只有代表画面索引，未上传低信息量半身讲课截图；梁冬对话和斯坦福演讲暂未接入截图证据。
...
- 已整理并接入截图图片：`01.针灸课程`、`03.黄帝内经课程`、`05.神农本草课程`、`07.伤寒论课程`、`09.金匮要略课程`、`11.仲景心法传讲`、`13.人纪之临床案例`、`15.扶阳论坛`、`18.倪师易筋经`、`22.倪海厦天纪`。
- 已整理文本和代表画面索引但未上传图片：`14.人纪之八纲辨证`。
- 已整理文本，截图证据待补跑：`19.梁冬对话倪师`、`20.倪师斯坦福大学演讲`。
- 待扩展：`02.针灸大成笔记` 等尚未蒸馏资料。
